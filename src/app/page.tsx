...
import { faHouseChimney, faPeopleGroup, faMoneyBillWave, faFilePdf } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="min-h-screen flex flex-col font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex-grow grid gap-8 grid-cols-1 md:grid-cols-1 xl:grid-cols-1 bg-white p-3 content-start">
        <div>
          ...
          <FontAwesomeIcon icon={faHouseChimney} size="2xl" className="text-brand" aria-hidden="true" />
        </div>
        ...
        <div>
          ...
          <FontAwesomeIcon icon={faPeopleGroup} size="2xl" className="text-brand" aria-hidden="true" />
        </div>
        ...
        <div>
          ...
          <FontAwesomeIcon icon={faMoneyBillWave} size="2xl" className="text-green-500" aria-hidden="true" />
        </div>
        <div className="bg-brand p-4 rounded-lg text-white text-[14px] md:text-[16px] leading-8">
            <p>
              Conveniently pay your homeowner&apos;s association dues online through our <a href="https://app.autobooks.co/pay/barry-brooke-homeowners-assoc" target="_blank" rel="noopener noreferrer" className="underline font-bold hover:text-yellow-300">secure payment portal</a> (opens in a new tab).
        ...
        <hr className="border-t border-gray-200 my-2" />
        <div>
          <h2 className="text-2xl font-light inline"><Link href="/documents">Documents</Link></h2>{" "}<FontAwesomeIcon icon={faFilePdf} size="2xl" aria-hidden="true" />
        </div>
        <div className="bg-brand p-4 rounded-lg text-white text-[14px] md:text-[16px] leading-8">
